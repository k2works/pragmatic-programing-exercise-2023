...
Prisma を使用することで、データベースの操作を簡単に行うことができます。以下の手順で Prisma をセットアップしてください。

#### パッケージのインストール

1. 以下のコマンドを実行して、Prisma をインストールしてください。
...
1. データベースドライバにはpostgresqlを使用します。以下のコマンドを実行して、データベースドライバをインストールしてください。
...
1. `prisma/schema.prisma` ファイルを編集してモデルを作成してください。
