...
ALTER TABLE sales
ADD CONSTRAINT FK_DEPT_MST_SALES FOREIGN KEY(dept_code, start_date) REFERENCES dept_mst (dept_code, start_date) ON UPDATE NO ACTION ON DELETE NO ACTION area_mst.updater IS '更新者名';
CREATE TABLE --     A.UNITPRICE UNITPRICE,
--     A.PO_PRICE PO_PRICE,
--     A.prime_cost COST,
--     A.TAX_TYPE TAX_TYPE,
